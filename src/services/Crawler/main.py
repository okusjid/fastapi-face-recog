        ...
        for keyword in keywords:
            ...
            if self.do_google and not google_done:
                if self.full_resolution:
                    tasks.append([keyword+' wrestler', Sites.GOOGLE_FULL])
                else:
                    tasks.append([keyword+' wrestler', Sites.GOOGLE])

            if self.do_naver and not naver_done:
                if self.full_resolution:
                    tasks.append([keyword+' wrestler', Sites.NAVER_FULL])
                else:
                    tasks.append([keyword+' wrestler', Sites.NAVER])
